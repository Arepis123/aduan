...
<div>
    <flux:heading size="lg" class="mb-6">Reset Password</flux:heading>

    <form wire:submit="resetPassword" class="space-y-6">
        <flux:field>
            <flux:label badge="Required">Email</flux:label>
            <flux:input wire:model="email" type="email" placeholder="Enter your email" autofocus autocomplete="username" />
