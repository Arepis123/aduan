<div class="min-h-[70vh] flex flex-col items-center justify-center space-y-12">
    ...
    <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <!-- Submit Ticket Card -->
        {{-- <flux:card class="group hover:shadow-lg transition-all cursor-pointer transition-transform duration-300 ease-out hover:scale-103 hover:shadow-xl !bg-white/30 dark:!bg-zinc-800/50 backdrop-blur-sm !border-0" href="{{ route('submit') }}" wire:navigate> --}}
        <flux:card class="group hover:shadow-lg transition-all cursor-pointer transition-transform duration-300 ease-out hover:scale-103 hover:shadow-xl !bg-teal-600/60 dark:!bg-zinc-800/50 backdrop-blur-xs !border-0" href="{{ route('submit') }}" wire:navigate>
        ...
        <!-- Check Status Card -->
        <flux:card class="group hover:shadow-lg transition-all cursor-pointer transition-transform duration-300 ease-out hover:scale-103 hover:shadow-xl !bg-teal-600/50 dark:!bg-zinc-800/50 backdrop-blur-xs !border-0" href="{{ route('check') }}" wire:navigate>
            <div class="flex items-center gap-4 mb-4">
