<div class="min-h-[70vh] flex flex-col items-center justify-center space-y-12">
    ...
    <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <!-- Submit Ticket Card -->
        <a href="{{ route('submit') }}" wire:navigate class="block transform transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-xl">
            <flux:card class="group h-full cursor-pointer !bg-teal-600/60 dark:!bg-zinc-800/50 backdrop-blur-xs !border-0">
        ...
        <!-- Check Status Card -->
        <a href="{{ route('check') }}" wire:navigate class="block transform transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-xl">
            <flux:card class="group h-full cursor-pointer !bg-teal-600/50 dark:!bg-zinc-800/50 backdrop-blur-xs !border-0">
                <div class="flex items-center gap-4 mb-4">
