<div class="min-h-[70vh] flex flex-col items-center justify-center space-y-12">
    ...
    <div class="text-center">
        <flux:heading size="xl" class="mb-4">Welcome to Sistem Aduan CLAB</flux:heading>
    ...
    <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <!-- Submit Ticket Card -->
        <flux:card class="group hover:shadow-lg transition-all cursor-pointer transition-transform duration-300 ease-out hover:scale-103 hover:shadow-xl" href="{{ route('submit') }}" wire:navigate>
        ...
        <!-- Check Status Card -->
        <flux:card class="group hover:shadow-lg transition-all cursor-pointer transition-transform duration-300 ease-out hover:scale-103 hover:shadow-xl" href="{{ route('check') }}" wire:navigate>
            <div class="flex items-center gap-4 mb-4">
